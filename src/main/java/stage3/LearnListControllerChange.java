 ...
 */
public class LearnListControllerChange extends Application {
    ...
    public void start(Stage stage) {
        ...
        list.setCellFactory((ListView<Student> l) -> new StudentRectCell());
...
//        g_stage.show();
    ...
    public static class StudentRectCell extends ListCell<Student> {
        @Override
